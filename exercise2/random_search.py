...
class MyWorker(Worker):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.x_train, self.y_train, self.x_valid, self.y_valid, self.x_test, self.y_test = cm.mnist("./")
    ...
    def compute(self, config, budget, **kwargs):
        ...
        learning_curve, model = cm.train_and_validate(self.x_train, self.y_train, self.x_valid, self.y_valid, epochs,
                                                      lr, num_filters, batch_size)
    ...
    def get_configspace():
        ...
        lr = CSH.UniformFloatHyperparameter('learning_rate', lower=10e-4, upper=10e-1, default_value='10e-2', log=True)
...
x_train, y_train, x_valid, y_valid, x_test, y_test = cm.mnist("./")
...
learning_curve, model = cm.train_and_validate(x_train, y_train, x_valid, y_valid, args.budget, lr, num_filters, batch_size)
test_error = cm.test(x_test, y_test, model)

print('Test error of best configuration {}'.format(test_error))
